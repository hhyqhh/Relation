...
from old_relation.relation.relation_model import FitnessCriteria_RSO as FitnessCriteria_RSO_old
from old_relation.relation.relation_model import CategoryCriteria_RSO as CategoryCriteria_RSO_old
from savedata.call_back import Base_Callback
...
class DRSO_OLD(GeneticAlgorithm):
    def __init__(self,
                 pop_size=50,
                 tao=100,
                 sample=LHS(),
                 ...
                 c1_model = FitnessCriteria_RSO_old(),
                 c2_model = CategoryCriteria_RSO_old(),
